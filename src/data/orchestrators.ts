...
export const governanceTools: OrchestrationToolEntry[] = [
  ...
  },
  {
    ...
    mark: "BF",
    summary:
      "Apache-2.0-licensed open-source AI gateway with provider routing, virtual-key access controls, budgets, rate limits, and MCP tool governance.",
    note:
      "Sits between agent runtimes and model or MCP endpoints; its documented virtual keys apply per-key budgets, rate limits, allowed models, and routing rules, while MCP tool filtering can default-deny and allow-list tools. Tracked as a governance and enforcement layer, not an orchestrator runtime.",
